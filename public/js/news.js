...
document.addEventListener("DOMContentLoaded", function (event) {
    ...
    function loadApi(start){
        axios.get('https://hacker-news.firebaseio.com/v0/topstories.json')
            .then((response) => {
                get30(start, start + 3, response.data);
            })
    ...
    // axios.get('http://standupmaths.com/')
    //     .then(response => {
    ...
    var something = 'https://devcenter.heroku.com/articles/static-sites-ruby';
});